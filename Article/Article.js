...
function component(title, date, p1, p2, p3) {
  ...
  article.append(pa2);
  article.append(pa3);
  article.append(spanButton);

  article.classList.add("article");
  h2.classList.add("h2");
  p.classList.add("p");
  pa1.classList.add("p1");
  pa2.classList.add("p2");
  pa3.classList.add("p3");
  ...
  spanButton.addEventListener("click", i => {
